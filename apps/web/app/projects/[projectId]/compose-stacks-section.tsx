...
export default async function ComposeStacksSection({ projectId }: { projectId: string }) {
  ...
  return (
    <section>
      ...
      <p>
        Register existing Docker Compose projects as first-class Argus resources. This phase only records the runtime identity; it does not upload Compose files, change containers, or expose arbitrary Docker commands.
      </p>
